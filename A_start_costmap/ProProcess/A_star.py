...
if __name__ == '__main__':
    ...
    #
    # give = [(-50.9570036884844, - 110.697099290399, 2.37690739972538), (-22.3223460808182, 59.9547553041359, 21.0320825339638)]
    # # num = 2
    #
    ...
    for i in range(1, size):
        astar = AStar(s_start, s_goal, data, "euclidean", alpha=i, angle = angle)     # alpha >= 10
    ...
    plt.plot(np.arange(1, size), gand, 'b*--', alpha=0.5, linewidth=1)
    plt.xlabel('惩罚值')  # x_label
    plt.ylabel('长度/惩罚值')  # y_label
    plt.title('路径规划长度与惩罚值比值图')
    plt.show()
